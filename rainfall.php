...
if (isset($_POST["selTown"])) {
  ...
  $sqlStatement = <<<mulity
  select rf_id, Cos_id, twn_id, location_name, ELEV, RAIN, HOUR_24, NOW
  from  tbl_rainfall_report
...
<body>
  ...
  <div class="container">
    <h1 style="text-align:center;">縣市各觀測站過去累積雨量</h1>
    ...
    <table class="table ">
      <thead class="thead-light">
        <tr style="text-align:center;">
          ...
          <th scope="col">一小時雨量</th>
          <th scope="col">24小時雨量</th>
          <th scope="col">當前雨量</th>
      ...
      <tbody>
          ...
          <tr style="text-align: center;">
            ...
            <td scope="col"><?=iszero($row["RAIN"]) ?></td>
            <td scope="col"><?=iszero($row["HOUR_24"]) ?></td>
            <td scope="col"><?=$row["NOW"] ?></td>
            </tr>
          <?php } ?>
      </tbody>
    </table>
